<template>
    <aside :class="`${is_expanded ? 'is-expanded bg-dark-pink' : 'bg-dark-pink'}`" >
        <div class="logo">
            <img src="/logo/petcare.svg" alt="animal care center logo" class="logo-img">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle text-white" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="/img/woman-icon.png" alt="" width="35" height="35" class="rounded-circle me-2">
...
const ToggleMenu = () => {
    ...
    if (is_expanded.value == true){
        setTimeout(function () {
            ...
            document.getElementsByClassName("logo-text")[0].style.display = "inline-block";
            document.getElementsByClassName("logo-text")[0].style.transition = "ease-in";
        }, 230);
    }else{
